            ...
            <section className="py-12">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <h3 className="text-5xl font-semibold text-gray-800 font-gwendolyn">Architectural Excellence</h3>
                        ...
                        <div>
                            <h3 className="text-5xl font-semibold text-gray-800 font-gwendolyn">Modern Amenities</h3>
                            <p className="mt-2 text-gray-600 leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-5xl font-semibold text-gray-800 font-gwendolyn">Rich History</h3>
                            <p className="mt-2 text-gray-600 leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-5xl font-semibold text-gray-800 font-gwendolyn">Prime Location</h3>
                            <p className="mt-2 text-gray-600 leading-relaxed">
