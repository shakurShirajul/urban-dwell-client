...
const MyProfile = () => {
  ...
  const apartmentDetails: Array<[string, string | number | undefined, IconType]> = [
    ...
    <div>
      ...
      <div className="grid gap-6 xl:grid-cols-[0.7fr_1.3fr]">
        <section className="surface-card p-7">
          {userData?.user_image ? <Image src={userData.user_image} alt="" width="160" height="160" className="size-40 rounded-[2rem] object-cover" /> : null}
