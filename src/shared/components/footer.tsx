...
const Footer = () => (
  <footer className="border-t border-base-content/10 bg-secondary text-secondary-content">
    <div className="app-shell grid gap-12 py-14 md:grid-cols-[1.5fr_1fr_1fr] lg:py-20">
      <div>
        <Link href="/" className="inline-flex items-center gap-3" aria-label="Urban Dwell home">
          <span className="grid size-14 place-items-center rounded-2xl bg-white/10">
            <Image src={logo.src} width="44" height="44" alt="" className="size-11 object-contain" />
          </span>
      ...
      <nav aria-label="Footer navigation">
        ...
        <ul className="mt-5 space-y-3 text-sm font-semibold">
          <li><Link href="/#apartments" className="hover:text-accent">Available apartments</Link></li>
          <li><Link href="/#building" className="hover:text-accent">The building</Link></li>
          <li><Link href="/#offers" className="hover:text-accent">Resident offers</Link></li>
          <li><Link href="/login" className="hover:text-accent">Resident dashboard</Link></li>
        </ul>
      </nav>
