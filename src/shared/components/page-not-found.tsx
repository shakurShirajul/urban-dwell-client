...
const PageNotFound = () => (
  <main className="architectural-grid grid min-h-screen place-items-center bg-atrium px-4 text-ink dark:bg-base-200 dark:text-base-content">
    <div className="max-w-xl text-center">
      ...
      <Link href="/" className="mt-9 inline-flex h-13 items-center gap-2 rounded-full bg-primary px-6 font-bold text-primary-content"><HiOutlineArrowLeft aria-hidden="true" /> Return home</Link>
    </div>
  </main>
);
